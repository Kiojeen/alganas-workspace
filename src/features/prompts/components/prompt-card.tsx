      ...
      <Card className="flex flex-col overflow-hidden transition-all hover:shadow-md">
          ...
          {prompt.imageUrl ? (
            ...
            >
              <Image
                ...
                height={350}
                width={400}
                quality={50} // 1. LOWERED QUALITY HERE
                alt={prompt.title}
                loading="lazy"
                className="h-full w-full object-cover transition-transform duration-200 group-hover:scale-[1.02]"
              />
              <span className="bg-background/85 text-foreground absolute right-2 bottom-2 flex size-8 items-center justify-center rounded-md opacity-0 shadow-sm transition-opacity group-hover:opacity-100">
        ...
        <CardContent className="grow p-4 pt-2">
          ...
          >
            ...
            <div className="text-muted-foreground h-48 min-h-24 overflow-y-auto p-3 pr-10 text-sm leading-relaxed wrap-break-word overflow-x-clip">
              {promptParts.map((part, i) =>
                part.type === "text" ? (
                  ...
                  <Input
                    ...
                    className={cn(
                      "bg-primary-foreground mx-0.5 inline-block h-auto min-w-8 rounded border px-1.5 py-0.5 text-sm focus-visible:ring-0",
                      copyError &&
